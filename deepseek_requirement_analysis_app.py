...
using an Agno multi-agent team powered by DeepSeek models.
    ...
    with col1:
        st.markdown(
            ...
            <div class="card">
                ...
                <div class="badge">DeepSeek models</div>
            </div>
            """,
...
def render_sidebar() -> AppConfig:
    with st.sidebar:
        ...
        model_id = st.selectbox("DeepSeek Model", MODEL_OPTIONS, index=0)
    ...
    if analyze_clicked:
        ...
        with tab_results:
            ...
            try:
                ...
                st.error("Analysis failed. Check your API key, model name, network connection, and Agno/DeepSeek provider setup.")
