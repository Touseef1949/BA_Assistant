...
def generate_pdf(project_name: str, result_markdown: str) -> bytes:
    ...
    pdf.cell(0, 6, sanitize_pdf_text(f"Generated by BA Assistant | {datetime.now().strftime('%Y-%m-%d %H:%M')}"), new_x=XPos.LMARGIN, new_y=YPos.NEXT, align="C")
    ...
    pdf.cell(0, 6, "Built by Touseef Shaik · touseefshaik.com", new_x=XPos.LMARGIN, new_y=YPos.NEXT, align="C")
